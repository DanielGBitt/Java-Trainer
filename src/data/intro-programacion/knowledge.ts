...
export const introProgramacionUnits: KnowledgeUnit[] = [
  {
    ...
    knowledge: [
      { id: "intro-web-fundamentos-def", type: "definition", content: "Web = cliente (navegador) pide vía HTTP/HTTPS y servidor responde HTML/CSS/JS." },
  ...
  },
  {
    ...
    knowledge: [
      { id: "intro-html-esqueleto-def", type: "definition", content: "<!doctype html> declara HTML5; <html> contiene <head> metadatos y <body> visible." },
  ...
  },
  {
    ...
    knowledge: [
      { id: "intro-html-semantica-def", type: "definition", content: "Semántica describe rol: header, nav, section, article, footer dan significado." },
  ...
  },
  {
    ...
    knowledge: [
      { id: "intro-enlaces-imagenes-def", type: "definition", content: "<a href=url>texto</a> navega; <img src alt> muestra imagen con alternativa." },
  ...
  },
  {
    ...
    knowledge: [
      { id: "intro-style-tablas-media-def", type: "definition", content: "<style> aplica CSS; table>tr>th/td estructura datos tabulares." },
  ...
  },
  {
    ...
    knowledge: [
      { id: "intro-formularios-def", type: "definition", content: "form con label+input/button captura datos para enviar." },
