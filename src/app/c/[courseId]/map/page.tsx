...
import { getAllUnits } from "@/engine/learning/knowledge";
...
export default function CourseMapPage() {
  ...
  const nodes = useMemo(() => {
    ...
    // relationships por curso: usa solo las que pertenecen a units del curso
    const unitIds = new Set(getAllUnits().map((u) => u.id));
    void unitIds;
